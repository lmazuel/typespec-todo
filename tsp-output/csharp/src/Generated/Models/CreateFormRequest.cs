...
{
    /// <summary> The CreateFormRequest. </summary>
    internal partial class CreateFormRequest
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CreateFormRequest"/>. </summary>
        ...
        public CreateFormRequest(string title, CreateFormRequestStatus status)
        {
        ...
        internal CreateFormRequest(long id, string title, long createdBy, long? assignedTo, string description, CreateFormRequestStatus status, DateTimeOffset createdAt, DateTimeOffset updatedAt, DateTimeOffset? completedAt, BinaryData labels, string dummy, IList<BinaryData> attachments, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Title = title;
            CreatedBy = createdBy;
        ...
        /// <summary> Initializes a new instance of <see cref="CreateFormRequest"/> for deserialization. </summary>
        internal CreateFormRequest()
        {
        }
        ...
        public CreateFormRequestStatus Status { get; }
